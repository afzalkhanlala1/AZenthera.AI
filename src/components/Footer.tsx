      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            <Link
              href="/"
              className="font-semibold text-[15px] text-foreground inline-block mb-4 tracking-tight"
            >
              AZenthera <span className="text-accent">AI</span>
            </Link>
            <p className="text-text-muted text-sm leading-relaxed mb-6 max-w-xs">
              Production-grade AI systems — from intelligent agents and computer
              vision to scalable data pipelines and executive dashboards.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li className="text-text-muted/60 text-xs pt-1">
        ...
        <div className="mt-12 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-text-muted text-xs">
            © {currentYear} AZenthera AI · Islamabad, Pakistan
          </p>
