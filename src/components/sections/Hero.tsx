...
export function Hero() {
  return (
    <section className="relative pt-32 md:pt-40 lg:pt-44 pb-20 grain">
      {/* Background canvas */}
      ...
      <div className="relative max-w-[1320px] mx-auto px-6 lg:px-10">
        ...
        <motion.div
          {...fade(0)}
          className="flex flex-wrap items-center justify-between gap-4 pb-12 hairline-b"
        >
        ...
        <div className="pt-14 lg:pt-20 grid lg:grid-cols-12 gap-y-10">
          <div className="lg:col-span-9">
            <motion.h1
              {...fade(0.05)}
              className="font-medium tracking-[-0.035em] leading-[0.92] text-foreground text-[14vw] sm:text-[12vw] md:text-[10vw] lg:text-[clamp(5rem,8.4vw,8.5rem)]"
            >
              We engineer
              <br />
          ...
          <motion.aside
            {...fade(0.18)}
            className="lg:col-span-3 lg:pt-3 lg:border-l lg:border-hairline lg:pl-8"
          >
            <p className="eyebrow mb-4">A · 01 / Manifest</p>
            <p className="text-[15px] leading-[1.55] text-text-muted max-w-[34ch]">
        ...
        <motion.div
          {...fade(0.32)}
          className="mt-20 lg:mt-28 grid grid-cols-2 lg:grid-cols-4 gap-px bg-hairline border-y border-hairline"
        >
          {[
            ...
            >
              ...
              <span className="text-[12.5px] text-text-muted">{stat.note}</span>
            </div>
          ))}
        </motion.div>
        ...
        >
          ...
          <div className="overflow-hidden hairline-y py-7 relative">
            ...
            <div className="marquee-track flex items-center gap-14 lg:gap-20 whitespace-nowrap">
              {[...clients, ...clients].map((c, i) => (
                <span
                  key={`${c}-${i}`}
                  className="font-display italic text-[28px] lg:text-[34px] text-text-muted/70 tracking-tight shrink-0"
                >
                  {c}
                </span>
              ))}
